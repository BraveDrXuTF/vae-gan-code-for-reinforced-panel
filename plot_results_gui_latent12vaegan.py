...
# 画图
def plot_results1d(models, experiment_dim=0, latent_dim=14):
    """1d
...
tfrecord_list = glob.glob('gene_no_random/*.tfrecords')
...
VAER_GAN_instance.load_weights(
    'vae_cnn_weights/modelepoch_13z2vaerGAN_Tue_Oct_26_21_51_38_2021.h5')
