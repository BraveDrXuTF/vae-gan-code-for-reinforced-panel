...
VAER_GAN_instance.load_weights('vae_cnn_weights/modelepoch_21z2vaer_ld14_GAN_Sat_Oct_30_12_25_24_2021.h5')
...
def collect_z(check_index=50, check_num=6):

    _, _, code = VAER_GAN_instance.encoder.predict(parsed_image_dataset)

    check_img = Image.open('gene/{}.jpg'.format(check_index))
   ...
   # print(check_img.shape)
    ...
    for i in range(check_num):
        ...
        plt.savefig('{}_{}.jpg'.format(i, current_time))
        plt.show()
